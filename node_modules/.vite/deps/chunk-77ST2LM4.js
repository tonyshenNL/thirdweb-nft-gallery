...
import {
  walletIds as walletIds2
} from "./chunk-3FKSJEH3.js";
import {
  Mr
} from "./chunk-RZA7Z4CS.js";
import {
  detect,
  esm_exports,
  formatJsonRpcResult
...
} from "./chunk-BTCHSOHK.js";
import {
  getInjectedMetamaskProvider
} from "./chunk-335TEGGE.js";
import {
  assertWindowEthereum
} from "./chunk-ELOBOROZ.js";
import {
  ThirdwebSDK,
  UserWallet,
...
} from "./chunk-7DCR5SHS.js";
import {
  walletIds
} from "./chunk-LUVJIMOL.js";
import {
  normalizeChainId
} from "./chunk-IH4C6MBP.js";
import {
...
import {
  require_react_is
} from "./chunk-2LHQRALI.js";
import {
  require_react_dom
} from "./chunk-D2OR6HFD.js";
import {
  require_react
...
init_shim();
var import_shim49 = __toESM(require_shim(), 1);
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/thirdweb-dev-wallets.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/smart-wallet-f5e628ca.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/base-402f7b12.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/abstract/dist/thirdweb-dev-wallets-evm-wallets-abstract.browser.esm.js
init_shim();
init_lib();
...
async function checkContractWalletSignature(message, signature, address, chainId) {
  const provider = new lib_exports2.JsonRpcProvider(chainIdToThirdwebRpc(chainId));
...
var AbstractWallet = class extends eventemitter3_default {
  ...
  async transfer(to, amount) {
    ...
    const signer = await this.getSigner();
    const from2 = await this.getAddress();
    if (!signer.provider) {
      throw new Error("Please connect a provider");
    }
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/wc-c6a6a61c.browser.esm.js
init_shim();
...
var WalletConnectV2Handler = class extends WalletConnectHandler {
  ...
  async init() {
    _classPrivateFieldSet(this, _wcWallet$1, await V.init({
...
function _getSignParamsMessage2(params) {
  const message = params.filter((p) => !utils_exports.isAddress(p))[0] || "";
...
var SmartWallet = class _SmartWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-UTVUVMFK.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/getInjectedCoinbaseProvider-980f40a9.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/paper-wallet/dist/thirdweb-dev-wallets-evm-wallets-paper-wallet.browser.esm.js
init_shim();
init_lib();
var PaperWallet = class _PaperWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-KSABOKDV.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/blocto/dist/thirdweb-dev-wallets-evm-wallets-blocto.browser.esm.js
init_shim();
init_lib();
var BloctoWallet = class _BloctoWallet extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-WQP4CBOE.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/coinbase-wallet/dist/thirdweb-dev-wallets-evm-wallets-coinbase-wallet.browser.esm.js
init_shim();
...
var CoinbaseWallet = class _CoinbaseWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-YRESTCRM.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/embedded-wallet/dist/thirdweb-dev-wallets-evm-wallets-embedded-wallet.browser.esm.js
init_shim();
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/embedded-wallet-82928b32.browser.esm.js
init_shim();
init_lib();
...
var IframeCommunicator = class {
  ...
  async call(_ref2) {
    ...
    while (!isIframeLoaded.get(this.iframe.src)) {
      await sleep2(this.POLLING_INTERVAL_SECONDS);
    }
    if (showIframe) {
...
var EthersSigner = class _EthersSigner extends Signer {
  constructor(_ref) {
    ...
    (0, import_utils21.defineReadOnly)(this, "provider", provider);
  }
  async getAddress() {
    const {
      address
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/ethers/dist/thirdweb-dev-wallets-evm-wallets-ethers.browser.esm.js
init_shim();
init_lib();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/frame/dist/thirdweb-dev-wallets-evm-wallets-frame.browser.esm.js
init_shim();
init_lib();
var FrameWallet = class _FrameWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-FBBHKVTJ.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/injected/dist/thirdweb-dev-wallets-evm-wallets-injected.browser.esm.js
init_shim();
init_lib();
var InjectedWallet = class _InjectedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-BC7YUVFK.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/local-wallet/dist/thirdweb-dev-wallets-evm-wallets-local-wallet.browser.esm.js
init_shim();
init_lib();
...
var LocalWallet = class _LocalWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-767ALINK.js");
...
async function _saveData2(data2, storage) {
  const _storage = storage || _classPrivateFieldGet(this, _storage2);
  await _storage.setItem(STORAGE_KEY_WALLET_DATA, JSON.stringify(data2));
}
...
function getDecryptor(encryption) {
  const noop3 = async (msg) => msg;
  return encryption ? (msg) => (encryption.decrypt || defaultDecrypt)(msg, encryption.password) : noop3;
}
function getEncryptor(encryption) {
  const noop3 = async (msg) => msg;
  return encryption ? (msg) => (encryption.encrypt || defaultEncrypt)(msg, encryption.password) : noop3;
}
function isValidPrivateKey(value) {
  return !!value.match(/^(0x)?[0-9a-f]{64}$/i);
}

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/signer/dist/thirdweb-dev-wallets-evm-wallets-signer.browser.esm.js
init_shim();
init_lib();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/magic/dist/thirdweb-dev-wallets-evm-wallets-magic.browser.esm.js
init_shim();
init_lib();
var MagicLink = class _MagicLink extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-IISOHNCP.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/metamask/dist/thirdweb-dev-wallets-evm-wallets-metamask.browser.esm.js
init_shim();
init_lib();
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-INHEOY7G.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-AD3SSY26.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/phantom/dist/thirdweb-dev-wallets-evm-wallets-phantom.browser.esm.js
init_shim();
init_lib();
var PhantomWallet = class _PhantomWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-GPQ6HQPE.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/private-key/dist/thirdweb-dev-wallets-evm-wallets-private-key.browser.esm.js
init_shim();
init_lib();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/rainbow-wallet/dist/thirdweb-dev-wallets-evm-wallets-rainbow-wallet.browser.esm.js
init_shim();
init_lib();
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-MBKCF6XX.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/safe/dist/thirdweb-dev-wallets-evm-wallets-safe.browser.esm.js
init_shim();
init_lib();
var SafeWallet = class _SafeWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-U3JKAUOZ.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/trust/dist/thirdweb-dev-wallets-evm-wallets-trust.browser.esm.js
init_shim();
init_lib();
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-ML5YKEGG.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/wallet-connect/dist/thirdweb-dev-wallets-evm-wallets-wallet-connect.browser.esm.js
init_shim();
init_lib();
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/wallet-connect-v1/dist/thirdweb-dev-wallets-evm-wallets-wallet-connect-v1.browser.esm.js
init_shim();
init_lib();

// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/evm/wallets/zerion/dist/thirdweb-dev-wallets-evm-wallets-zerion.browser.esm.js
init_shim();
init_lib();
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-HUMTCCOV.js");
...
// node_modules/@thirdweb-dev/react-core/node_modules/@thirdweb-dev/wallets/dist/auth-e91a1229.browser.esm.js
init_shim();
...
function ThirdwebWalletProvider(props) {
  ...
  const setConnectedWallet = (0, import_react7.useCallback)(async function(wallet, connectParams) {
    ...
    const _signer2 = await wallet.getSigner();
    setSigner(_signer2);
    if (isAutoConnect) {
      return;
    }
  ...
  const switchChain = (0, import_react7.useCallback)(async (chainId) => {
    ...
    const _signer2 = await activeWallet.getSigner();
...
function ChangeActiveWalletOnAccountSwitch() {
  ...
  const queryClient = useQueryClient();
  (0, import_react7.useEffect)(() => {
    const handleSwitchAccount = async (data2) => {
      if (!data2.address) {
        return;
      }
      try {
        await switchAccount(data2.address);
      } catch (err) {
        console.debug(`[Auth] Failed to switch account to ${data2.address} with error:
`, err);
      }
    };
...
function useSetClaimConditions(contract, tokenId) {
  ...
  return useMutation(async (data2) => {
...
function useClaimNFT(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    if (erc1155) {
      requiredParamInvariant(data2.tokenId, "tokenId not provided");
      if (!data2.to) {
        return await erc1155.claim(data2.tokenId, data2.quantity, data2.options);
      }
      return await erc1155.claimTo(data2.to, data2.tokenId, data2.quantity, data2.options);
    }
    if (erc721) {
      if (!data2.to) {
        return await erc721.claim(data2.quantity, data2.options);
      }
      return await erc721.claimTo(data2.to, data2.quantity, data2.options);
    }
...
function useLazyMint(contract, onProgress) {
  ...
  return useMutation(async (data2) => {
    ...
    if (erc721) {
      return erc721.lazyMint(data2.metadatas, options);
    }
    if (erc1155) {
      return erc1155.lazyMint(data2.metadatas, options);
    }
    invariant(false, "contract is not an Erc721 or Erc1155");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useDelayedRevealLazyMint(contract, onProgress) {
  ...
  return useMutation(async (data2) => {
    ...
    if (erc721) {
      return await erc721.revealer.createDelayedRevealBatch(data2.placeholder, data2.metadatas, data2.password, options);
    }
    if (erc1155) {
      return await erc1155.revealer.createDelayedRevealBatch(data2.placeholder, data2.metadatas, data2.password, options);
    }
    invariant(false, "contract is not an Erc721 or Erc1155");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useRevealLazyMint(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    if (erc721) {
      return await erc721.revealer.reveal(data2.batchId, data2.password);
    }
    if (erc1155) {
      return await erc1155.revealer.reveal(data2.batchId, data2.password);
    }
    invariant(false, "contract is not an Erc721 or Erc1155");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useCreateDirectListing(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    if (isV1) {
      ...
      return await contract.direct.createListing(data2);
    } else if (!isV1) {
      invariant(contract.directListings.createListing, "contract does not support directListings.createListing");
      return await contract.directListings.createListing(data2);
    }
    invariant(false, "Contract is not a valid marketplace contract");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useCreateAuctionListing(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    if (isV1) {
      ...
      return await contract.auction.createListing(data2);
    } else if (!isV1) {
      invariant(contract.englishAuctions.createAuction, "contract does not support englishAuctions.createAuction");
      return await contract.englishAuctions.createAuction(data2);
    }
    invariant(false, "Contract is not a valid marketplace contract");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useMakeBid(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    return await contract.auction.makeBid(data2.listingId, data2.bid);
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
  });
}
function useMakeOffer(contract) {
  ...
  return useMutation(async (data2) => {
    invariant(walletAddress, "no wallet connected, cannot make bid");
    requiredParamInvariant(contract, "No Contract instance provided");
    return await contract.makeOffer(data2.listingId, data2.pricePerToken, data2.quantity);
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
  });
}
function useAcceptDirectListingOffer(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    return await contract.direct.acceptOffer(data2.listingId, data2.addressOfOfferor);
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
  });
}
function useExecuteAuctionSale(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    return await contract.auction.executeSale(data2.listingId);
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
  });
}
...
function useBuyDirectListing(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    return await contract.directListings.buyFromListing(data2.listingId, data2.quantity, data2.buyer);
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
  });
}
...
function useMintNFT(contract) {
  ...
  return useMutation(async (data2) => {
    invariant(data2.to, 'No "to" address provided');
    requiredParamInvariant(contract, "contract is undefined");
    if (erc1155) {
      invariant("supply" in data2, "supply not provided");
      const {
        to,
        metadata,
        supply
    ...
    if (erc721) {
      return await erc721.mintTo(data2.to, data2.metadata);
    }
    invariant(false, "Unknown NFT type");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useMintNFTSupply(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    requiredParamInvariant(contract, "contract is undefined");
    requiredParamInvariant(data2.tokenId, "tokenId not provided");
    invariant("additionalSupply" in data2, "additionalSupply not provided");
    const {
      to,
      tokenId,
      additionalSupply
...
function useTransferNFT(contract) {
  ...
  return useMutation((data2) => {
    invariant("to" in data2, "to not provided");
    if (erc1155) {
      invariant(erc1155.transfer, "contract does not support transfer");
      requiredParamInvariant(data2.tokenId, "tokenId not provided");
      invariant("amount" in data2, "amount not provided");
      return erc1155.transfer(data2.to, data2.tokenId, data2.amount);
    }
    if (erc721) {
      return erc721.transfer(data2.to, data2.tokenId);
    }
    invariant(false, "Unknown NFT type");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useBurnNFT(contract) {
  ...
  return useMutation(async (data2) => {
    requiredParamInvariant(data2.tokenId, "No tokenId provided");
    requiredParamInvariant(contract, "contract is undefined");
    if (erc1155) {
      invariant("amount" in data2, "amount not provided");
      const {
...
function useSetSharedMetadata(contract) {
  ...
  return useMutation(async (data2) => {
    if (erc721) {
      return await erc721.sharedMetadata.set(data2);
    }
    invariant(false, "Unknown NFT type");
  }, {
    onSettled: () => invalidateContractAndBalances(queryClient, contractAddress, activeChainId)
...
function useIsAddressRole(contract, role, walletAddress) {
  ...
  if (data2 == null ? void 0 : data2.includes(lib_exports.AddressZero)) {
    return true;
  }
  return !!(walletAddress && (data2 == null ? void 0 : data2.includes(walletAddress)));
}
...
function useClaimToken(contract) {
  ...
  return useMutation(async (data2) => {
    ...
    if (erc20) {
      ...
      return await erc20.claimTo(data2.to, data2.amount, {
        checkERC20Allowance: data2.checkERC20Allowance
      });
    }
    invariant(false, "Smart contract is not a valid erc20 contract");
  }, {
...
function useTransferBatchToken(contract) {
  ...
  return useMutation((data2) => {
    if (erc20) {
      ...
      const convertedData = data2.map((token2) => ({
        toAddress: token2.to,
...
function useStorageUpload(uploadOptions) {
  ...
  return useMutation(async (_ref) => {
    ...
    return await sdk.storage.uploadBatch(data2, options || uploadOptions);
  });
}
function useStorage() {
  const sdk = useSDK();
...
var WalletSelector = (props) => {
  ...
  const localWalletConfig = props.walletConfigs.find((w) => w.id === walletIds2.localWallet);
  const nonLocalWalletConfigs = props.walletConfigs.filter((w) => w.id !== walletIds2.localWallet);
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-77ST2LM4.js.map
