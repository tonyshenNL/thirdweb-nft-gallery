import { m as THIRDWEB_AUTH_ACTIVE_ACCOUNT_COOKIE, n as THIRDWEB_AUTH_TOKEN_COOKIE_PREFIX, k as LoginPayloadOutputSchema, o as THIRDWEB_AUTH_DEFAULT_REFRESH_INTERVAL_IN_SECONDS, q as THIRDWEB_AUTH_DEFAULT_TOKEN_DURATION_IN_SECONDS, T as ThirdwebAuth$1 } from '../../dist/auth-05a8826c.browser.esm.js';
import { z } from 'zod';
...
async function ThirdwebAuthRouter(req, res, ctx) {
  ...
  switch (action) {
    case "payload":
      return await handler$4(req, res, ctx);
    case "login":
      return await handler$3(req, res, ctx);
    case "user":
...
export { ActiveBodySchema, LoginPayloadBodySchema, PayloadBodySchema, ThirdwebAuth };
