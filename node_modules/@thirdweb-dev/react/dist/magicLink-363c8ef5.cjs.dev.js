...
function magicLink(config) {
  ...
  return {
    ...
    connectUI(props) {
      if (props.modalSize === "wide") {
        return /*#__PURE__*/jsxRuntime.jsx(MagicConnectionUIWide, {
          ...props,
          type: type,
          emailLogin: emailLoginEnabled,
          smsLogin: smsLoginEnabled,
      ...
      return /*#__PURE__*/jsxRuntime.jsx(MagicConnectionUICompact, {
        ...props,
        type: type
      });
    },
...
const MagicUI = props => {
  ...
  const socialIconSize = props.modalSize === "compact" ? formElements.iconSize.md : formElements.iconSize.lg;
