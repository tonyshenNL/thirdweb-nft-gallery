...
var formElements = require('./formElements-3014717d.cjs.dev.js');
...
var Tooltip = require('./Tooltip-ea75bcde.cjs.dev.js');
...
var coinbaseWallet = require('./formFields-4833c1a2.cjs.dev.js');
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./formFields-4833c1a2.cjs.dev.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./formFields-4833c1a2.cjs.dev.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./formFields-4833c1a2.cjs.dev.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./formFields-4833c1a2.cjs.dev.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-e943c8d6.cjs.dev.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-30b96b4f.cjs.dev.js'); }).then(function (n) { return n.paperWallet$1; });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-ae77073a.cjs.dev.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./formFields-4833c1a2.cjs.dev.js'); }).then(function (n) { return n.walletConnect$1; });
