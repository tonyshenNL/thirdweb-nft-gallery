...
import { T as ToolTip, s as smartWalletIcon } from './Tooltip-b590d7e9.esm.js';
...
import { F as FormFieldWithIconButton, Q as QRCode, W as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './formFields-91a5abcd.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./formFields-91a5abcd.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./formFields-91a5abcd.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./formFields-91a5abcd.esm.js').then(function (n) { return n.f; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./formFields-91a5abcd.esm.js').then(function (n) { return n.e; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-a032da31.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-c4ff0310.esm.js').then(function (n) { return n.a; });
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-8f7a3848.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./formFields-91a5abcd.esm.js').then(function (n) { return n.g; });
