...
var WalletConnect__default = /*#__PURE__*/_interopDefault(WalletConnect);
...
class WalletConnectV1Handler extends WalletConnectHandler {
  constructor(options) {
    super();
    classPrivateMethodGet._classPrivateMethodInitSpec(this, _setupWalletConnectEventsListeners$2);
    classPrivateMethodGet._classPrivateMethodInitSpec(this, _parseTxParams);
    classPrivateMethodGet._classPrivateMethodInitSpec(this, _init);
    classPrivateFieldSet._classPrivateFieldInitSpec(this, _wcMetadata$1, {
      writable: true,
      value: void 0
    });
    classPrivateFieldSet._classPrivateFieldInitSpec(this, _wcWallet$2, {
      writable: true,
      value: void 0
    });
    classPrivateFieldSet._classPrivateFieldInitSpec(this, _activeSessionPayload, {
      writable: true,
      value: void 0
    });
    classPrivateFieldSet._classPrivateFieldInitSpec(this, _activeCallRequest, {
      writable: true,
      value: void 0
    });
    ...
    classPrivateFieldSet._classPrivateFieldInitSpec(this, _sessionStorage, {
      writable: true,
      value: void 0
    });
    classPrivateFieldSet._classPrivateFieldSet(this, _wcMetadata$1, options?.walletConnectWalletMetadata || {
      name: "Thirdweb Smart Wallet",
      description: "Thirdweb Smart Wallet",
      url: "https://thirdweb.com",
      icons: ["https://thirdweb.com/favicon.ico"]
    });
    classPrivateFieldSet._classPrivateFieldSet(this, _storage, options.storage);
    classPrivateFieldSet._classPrivateFieldSet(this, _sessionStorage, new SessionStorage(options.storage));
  }
  async init() {
    const uri = classPrivateFieldSet._classPrivateFieldGet(this, _storage).getItem(STORAGE_URI_KEY);
    if (uri) {
      classPrivateMethodGet._classPrivateMethodGet(this, _init, _init2).call(this, uri);
    }
    return Promise.resolve();
  }
  async connectApp(uri) {
    if (!classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)) {
      classPrivateFieldSet._classPrivateFieldGet(this, _storage).setItem(STORAGE_URI_KEY, uri);
      classPrivateMethodGet._classPrivateMethodGet(this, _init, _init2).call(this, uri);
    }
    return Promise.resolve();
  }
  async approveSession(wallet) {
    ...
    await classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2).approveSession({
      accounts: [address],
      chainId: chainId
    });
  ...
  rejectSession() {
    ...
    classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2).rejectSession();
    return Promise.resolve();
  }
  async approveEIP155Request(wallet) {
    const {
      params,
      method
    } = classPrivateFieldSet._classPrivateFieldGet(this, _activeCallRequest);
    try {
      let result;
      switch (method) {
        case wc.EIP155_SIGNING_METHODS.ETH_SIGN:
          const ethMsg = params[1];
          result = await wallet.signMessage(ethers.utils.arrayify(ethMsg));
          break;
        case wc.EIP155_SIGNING_METHODS.PERSONAL_SIGN:
          const message = params[0];
          result = await wallet.signMessage(ethers.utils.arrayify(message));
          break;
        case wc.EIP155_SIGNING_METHODS.ETH_SEND_TRANSACTION:
          const chainId = await wallet.getChainId();
          const signer = await wallet.getSigner();
          const tx = await signer.sendTransaction(classPrivateMethodGet._classPrivateMethodGet(this, _parseTxParams, _parseTxParams2).call(this, params, chainId));
          const {
            transactionHash
          } = await tx.wait();
        ...
        case wc.EIP155_SIGNING_METHODS.ETH_SIGN_TRANSACTION:
          ...
          const txParams = await signerSign.populateTransaction(classPrivateMethodGet._classPrivateMethodGet(this, _parseTxParams, _parseTxParams2).call(this, params, chainIdSign));
          result = await signerSign.signTransaction(txParams);
          break;
        case wc.EIP155_SIGNING_METHODS.SWITCH_CHAIN:
          {
      ...
      classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.approveRequest({
        id: classPrivateFieldSet._classPrivateFieldGet(this, _activeCallRequest)?.id,
        result
      });
    } catch (error) {
      let message;
      ...
      classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.rejectRequest({
        id: classPrivateFieldSet._classPrivateFieldGet(this, _activeCallRequest)?.id,
        error: {
          message
        }
  ...
  getActiveSessions() {
    const session = classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.session;
    if (!session) {
      return [];
    }
    const result = [{
  ...
  async disconnectSession() {
    classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.killSession();
    classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.off("session_request");
    classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.off("call_request");
    classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2)?.off("disconnect");
    classPrivateFieldSet._classPrivateFieldGet(this, _storage).removeItem(STORAGE_URI_KEY);
    classPrivateFieldSet._classPrivateFieldSet(this, _wcWallet$2, undefined);
    this.emit("session_delete");
    return Promise.resolve();
  }
}
function _init2(uri) {
  classPrivateFieldSet._classPrivateFieldSet(this, _wcWallet$2, new WalletConnect__default["default"]({
    uri: uri,
    clientMeta: classPrivateFieldSet._classPrivateFieldGet(this, _wcMetadata$1),
    storage: classPrivateFieldSet._classPrivateFieldGet(this, _sessionStorage)
  }));
  classPrivateMethodGet._classPrivateMethodGet(this, _setupWalletConnectEventsListeners$2, _setupWalletConnectEventsListeners2$2).call(this);
}
...
function _setupWalletConnectEventsListeners2$2() {
  ...
  classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2).on("session_request", (error, payload) => {
    if (error) {
      throw new Error(`WCV1H.session_request error: ${error.message}`);
    }
    classPrivateFieldSet._classPrivateFieldSet(this, _activeSessionPayload, payload);
  ...
  classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2).on("call_request", (error, payload) => {
    if (error) {
    ...
    classPrivateFieldSet._classPrivateFieldSet(this, _activeCallRequest, payload);
    switch (method) {
      case wc.EIP155_SIGNING_METHODS.ETH_SIGN:
      case wc.EIP155_SIGNING_METHODS.PERSONAL_SIGN:
        const message = params[0];
        ...
        this.emit("session_request", {
          ...
          params: paramsCopy,
          peer: {
            metadata: classPrivateFieldSet._classPrivateFieldGet(this, _activeSessionPayload).params[0].peerMeta
          },
          method: method
        });
        return;
  ...
  classPrivateFieldSet._classPrivateFieldGet(this, _wcWallet$2).on("disconnect", error => {
    if (error) {
...
class SessionStorage {
  constructor(storage) {
    ...
    classPrivateFieldSet._classPrivateFieldSet(this, _storage2, storage);
  }
  getSession() {
    const session = classPrivateFieldSet._classPrivateFieldGet(this, _storage2).getItem("session");
    if (!session) {
      return null;
    }
  ...
  setSession(session) {
    classPrivateFieldSet._classPrivateFieldGet(this, _storage2).setItem("session", JSON.stringify(session));
    return session;
  }
  removeSession() {
    classPrivateFieldSet._classPrivateFieldGet(this, _storage2).removeItem("session");
  }
}
...
class SmartWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  ...
  constructor(options) {
    ...
    classPrivateFieldSet._classPrivateFieldSet(this, _wcWallet, this.enableConnectApp ? options?.wcVersion === "v1" ? new WalletConnectV1Handler({
...
exports.WalletConnectV1Handler = WalletConnectV1Handler;
